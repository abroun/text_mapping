...
#include "CM5_Libs/include/serial.h"
#include "CM5_Libs/include/dynamixel.h"
...
// motors 5 and 6. The frames are linked to each other to form a looping 
...
void SetupAnimationTest()
{
    ...
    ANIM_SetMotorPostionAndSpeed( 5, 0, 256 );
    ANIM_SetMotorPostionAndSpeed( 6, 1023, 256 );
    ANIM_SetNextFrame( 1 );
    ANIM_SetWaitTimeMS( 1000 );
    
    ANIM_SetAnimationFrame( 1 );
    ANIM_ClearCurrentFrame();
    ANIM_SetMotorPostionAndSpeed( 5, 1023, 256 );
    ANIM_SetMotorPostionAndSpeed( 6, 0, 256 );
    ANIM_SetNextFrame( 0 );
    ANIM_SetWaitTimeMS( 1000 );
